...
export default function Profile({ navigation }) {
    ...
    createAlert({
      ...
      options: [
        ...
        },
        {
          ...
          onPress: () => {
            signOut(auth);
            dispatch(update({ isLoggedIn: false, uid: "", name: "" }));
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={{ paddingHorizontal: 20 }}>
        <Text
          style={{
            fontSize: 28,
            fontWeight: "bold",
            color: colors.primary.taro["taro-darkest"],
            marginBottom: 20,
          }}
        >
          Profile
        ...
        <View
          style={{
            borderWidth: 1,
            borderColor: colors.primary.taro["taro-lighter"],
            padding: 15,
            backgroundColor: "white",
            borderRadius: 10,
            flexDirection: "row",
      ...
      >
        <Text style={{ fontWeight: "700", marginBottom: 30, fontSize: 20 }}>
          Akun
        </Text>
        <View
          style={{
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View
              style={{
                borderRadius: 50,
                backgroundColor: colors.primary.taro["taro"],
                padding: 5,
              }}
            >
              <MaterialCommunityIcons name="history" size={30} color="white" />
            </View>
            <Text style={{ marginLeft: 25, fontSize: 20, fontWeight: "700" }}>
              Riwayat
            </Text>
          </View>
